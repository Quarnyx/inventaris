<?php
include "../../config.php";
$sql_validasi = "SELECT * FROM validasi WHERE id_validasi = '$_POST[id]'";
$result_validasi = $conn->query($sql_validasi);
if ($result_validasi->num_rows > 0) {
    $row_validasi = $result_validasi->fetch_assoc();
}
$sql = "SELECT * FROM aset WHERE id_aset = '$row_validasi[id_aset]'";
    ...
    <div class="col-md-12">
        <div class="card-box">
            ...
            <form id="form-tambah">
                ...
                <div class="form-row">
                    <input type="hidden" name="id_validasi" value="<?php echo $row_validasi['id_validasi']; ?>">
                    <div class="form-group col-md-6">
                        ...
                        <textarea type="text" class="form-control" id="keterangan_validasi"
                            placeholder="Keterangan Validasi Aset" name="keterangan_validasi"
                            rows="5"><?php echo $row_validasi['keterangan_validasi']; ?></textarea>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <input type="file" class="filestyle" name="bukti_dokumen">
                            <input type="hidden" name="bukti_dokumen_lama"
                                value="<?php echo $row_validasi['bukti_dokumen']; ?>">
                        </div>
...
<script>
    $(document).ready(function () {
        $(":file").filestyle({
            ...
            placeholder: "<?php echo $row_validasi['bukti_dokumen']; ?>",
        });
        $('#form-tambah').submit(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'pages/validasi/proses-validasi.php?aksi=edit-validasi',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
